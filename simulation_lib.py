...
def investment_horizons(observed_path=None,
    ...
    """
     ...
     - params:
         ...
         - plotting_1: boolean; showing some of the simulated return paths            
         - plotting_2: boolean; visualizing the histogram(s) of the statistic(s) 
...
class Simulation:
    ...
    def __init__(self,
        ...
        self.stats = stats
        self.plotting_1 = plotting_1
        self.plotting_2 = plotting_2
    ...
    def normal(self):
        ...
        self.store_output = investment_horizons(
            ...
            simulation_tech='Normal',
            plotting_1=self.plotting_1,
            plotting_2=self.plotting_2)
        return None
